 ...
 */
public class MultipleItemQuickAdapter extends BaseMultiItemQuickAdapter<StockEntity.StockInfo> implements PinnedHeaderNotifyer<StockEntity.StockInfo> {

    public MultipleItemQuickAdapter(List<StockEntity.StockInfo> data) {
        super(data);
